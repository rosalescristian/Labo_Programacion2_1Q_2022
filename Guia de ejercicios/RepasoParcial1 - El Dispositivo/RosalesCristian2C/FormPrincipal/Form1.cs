...
using RosalesCristian2C;
using static RosalesCristian2C.Aplication;

namespace FormPrincipal
{
    public partial class RPPRosalesCristian : Form
    {
        //public enum SistemaOperativo
        //{
        //    ANDROID, IOS
        //}
        public RPPRosalesCristian()
        {
            InitializeComponent();
        }

        private void RPPRosalesCristian_Load(object sender, EventArgs e)
        {
            List<Aplication> listaApps = new List<Aplication>()
            {
              ...
              new AppMusical("YouTube Music", SistemaOperativo.ANDROID, 30) // Lo debe agregar.
                        ...
                        foreach (Aplication app in listaApps)
                        {
